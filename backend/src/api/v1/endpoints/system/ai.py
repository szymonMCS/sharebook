...
class ChatRequest(BaseModel):
    message: str
    model_config = ConfigDict(json_schema_extra={"example": {"message": "Poleć mi fantasy z magią"}})
...
async def ai_health_check(
    ...
    try:
        ...
        return HealthResponse(status="healthy", vector_db=stats)
    except Exception as e:
        return HealthResponse(status="unhealthy", vector_db={"error": str(e)})
